...
explode = pygame.mixer.Sound("big.wav")
explode.set_volume(0.1)

mis_sound = pygame.mixer.Sound("shot.wav")
mis_sound.set_volume(0.1)
...
while SB == 0:
    ...
    screen.blit(text_time, (size[0] - 500, 5))
